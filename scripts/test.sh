...
const TESTS = [
  ...
  'static/js/modules/analyzer/local/text-preprocess.test.html',
  ...
  'static/js/modules/ui/position.test.html',
  'static/js/modules/ui/toolbar-content.test.html',
  'static/js/modules/i18n/detect.test.html',
  ...
  'static/js/modules/docs/search.test.html',
  'static/js/modules/audio/wav.test.html',
  'static/js/modules/util/index.test.html',
  'static/js/modules/backup/doc-export.test.html',
  'static/js/modules/editor/editor-toolbar.test.html',
  'static/js/modules/gemini/client.test.html',
  'static/js/modules/analyzer/ui/article-summary-helpers.test.html',
  'static/js/modules/analyzer/ui/vocab-helpers.test.html',
  'static/js/modules/youtube/url.test.html',
  'static/js/modules/youtube/oembed.test.html',
  'static/js/modules/youtube/prompts.test.html',
  'static/js/modules/youtube/gemini-yt.test.html',
  'static/js/modules/youtube/index.test.html',
  'static/js/modules/youtube/tabs/import.test.html',
  'static/js/modules/youtube/tabs/companion-sync.test.html',
  'static/js/modules/youtube/tabs/listening.test.html',
];
