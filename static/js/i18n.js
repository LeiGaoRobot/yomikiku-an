...
const I18N = {
  ja: {
    ...
    // JLPT redesign additions (ja)
    ,'panel.jlpt.title': '🎧 JLPT 聴解練習'
    ,'panel.jlpt.tab.practice': '🎯 練習'
    ,'panel.jlpt.tab.exam': '📝 模擬試験'
    ,'panel.jlpt.tab.history': '📊 成績'
    ,'panel.jlpt.mode.kadai': '課題理解'
    ,'panel.jlpt.mode.point': 'ポイント理解'
    ,'panel.jlpt.mode.gist': '概要理解'
    ,'panel.jlpt.mode.hatsu': '発話表現'
    ,'panel.jlpt.mode.sokuji': '即時応答'
    ,'panel.jlpt.mode.togo': '統合理解'
    ,'panel.jlpt.exam.start': '試験を開始'
    ,'panel.jlpt.exam.submit': '提出'
    ,'panel.jlpt.coach.title': '弱点：{mode}'
    ,'panel.jlpt.coach.cta': '🎯 集中練習'
    ,'panel.jlpt.shadow.label': 'シャドーイング'
    ,'panel.jlpt.shadow.record': '🎤 録音'
    ,'panel.summary.section.vocabulary': '重要語彙'
    ,'panel.summary.section.grammar': '文法ポイント'
    ,'panel.summary.export': '📤 Markdown をエクスポート'
  ...
  en: {
    ...
    // JLPT redesign additions (en)
    ,'panel.jlpt.title': '🎧 JLPT Listening Practice'
    ,'panel.jlpt.tab.practice': '🎯 Practice'
    ,'panel.jlpt.tab.exam': '📝 Mock Exam'
    ,'panel.jlpt.tab.history': '📊 History'
    ,'panel.jlpt.mode.kadai': 'Task comprehension'
    ,'panel.jlpt.mode.point': 'Point comprehension'
    ,'panel.jlpt.mode.gist': 'Gist comprehension'
    ,'panel.jlpt.mode.hatsu': 'Utterance expression'
    ,'panel.jlpt.mode.sokuji': 'Quick response'
    ,'panel.jlpt.mode.togo': 'Integrated comprehension'
    ,'panel.jlpt.exam.start': 'Start exam'
    ,'panel.jlpt.exam.submit': 'Submit'
    ,'panel.jlpt.coach.title': 'Weak spot: {mode}'
    ,'panel.jlpt.coach.cta': '🎯 Targeted practice'
    ,'panel.jlpt.shadow.label': 'Shadowing'
    ,'panel.jlpt.shadow.record': '🎤 Record'
    ,'panel.summary.section.vocabulary': 'Vocabulary'
    ,'panel.summary.section.grammar': 'Grammar points'
    ,'panel.summary.export': '📤 Export Markdown'
  ...
  zh: {
    ...
    // JLPT redesign additions (zh)
    ,'panel.jlpt.title': '🎧 JLPT 听力练习'
    ,'panel.jlpt.tab.practice': '🎯 单题练习'
    ,'panel.jlpt.tab.exam': '📝 模拟考试'
    ,'panel.jlpt.tab.history': '📊 成绩记录'
    ,'panel.jlpt.mode.kadai': '任务理解'
    ,'panel.jlpt.mode.point': '要点理解'
    ,'panel.jlpt.mode.gist': '概要理解'
    ,'panel.jlpt.mode.hatsu': '发话表现'
    ,'panel.jlpt.mode.sokuji': '即时应答'
    ,'panel.jlpt.mode.togo': '综合理解'
    ,'panel.jlpt.exam.start': '开始考试'
    ,'panel.jlpt.exam.submit': '交卷'
    ,'panel.jlpt.coach.title': '薄弱题型：{mode}'
    ,'panel.jlpt.coach.cta': '🎯 专项练习'
    ,'panel.jlpt.shadow.label': '跟读'
    ,'panel.jlpt.shadow.record': '🎤 录音'
    ,'panel.summary.section.vocabulary': '重要词汇'
    ,'panel.summary.section.grammar': '语法点'
    ,'panel.summary.export': '📤 导出 Markdown'
    ,'panel.jlpt.type.dialogue': '対話'
