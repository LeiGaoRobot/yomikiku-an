...
//   yt-transcript       — plain-text transcript per (videoId,range), small/medium
//   yt-transcript-timed — timed-JSON transcript per (videoId,range), medium
//   yt-jlpt             — JLPT questions per (videoId,range,mode,level,count), medium-large
//   mock                — dev fixture; keep a few around
//   default             — fallback bucket for unknown providers
//
// Total implicit budget ≈ 650 entries. TTL and the underlying IDB schema
